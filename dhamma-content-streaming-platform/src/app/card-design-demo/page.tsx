...
const sampleContent: DhammaContentWithRelations[] = [
  ...
  {
    id: 2,
    title: "The Four Noble Truths: Understanding Suffering",
    content_type: "video",
    file_url: "/sample/video1.mp4",
    duration_estimate: 120,
    language: "English",
    description:
      "A comprehensive exploration of the Buddha's first teaching, examining the nature of suffering and the path to liberation.",
    speaker_id: 2,
    category_id: 2,
    file_size_estimate: null,
    date_recorded: "2023-12-10",
    source_page: null,
    scraped_date: null,
    ...
    speaker: {
      ...
      bio: "Influential Theravada Buddhist monk and author",
      photo_url: null,
      created_at: "2024-01-01T00:00:00Z"
    }
  },
  {
    ...
    content_type: "ebook",
    file_url: "/sample/book1.pdf",
    duration_estimate: null,
    language: "English",
    description:
      "A classic text on vipassana meditation practice, offering practical guidance for developing insight and wisdom.",
    speaker_id: 3,
    category_id: 3,
    file_size_estimate: null,
    date_recorded: null,
    ...
    speaker: {
      id: 3,
      name: "Nyanaponika Thera",
      bio: "German-born Theravada Buddhist monk and scholar",
      photo_url: null,
      created_at: "2024-01-01T00:00:00Z"
    }
  },
  {
    id: 4,
    title: "Daily Dharma Practice",
    content_type: "audio",
    file_url: "/sample/audio2.mp3",
    duration_estimate: 30,
    language: "English",
    description: null, // No description to test layout
    speaker_id: null, // No speaker to test layout
    category_id: 1,
    file_size_estimate: null,
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <p className="text-green-700 text-sm mt-1">
                  Visit the browse pages, speaker pages, or content pages to see
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-600 mb-6">
            Emphasizes content information over images. Uses content type icons
            and provides more space for descriptions and metadata. Best for
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-600 mb-6">
            ...
            Would use image-based layout when thumbnails exist, and text-focused
            layout otherwise.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sampleContent.map((content) => (
        ...
        <section className="bg-white rounded-lg p-8 shadow-md border border-orange-100">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li>
                  • <strong>Compact horizontal design</strong> across all browse
                  pages
                </li>
                <li>
                  • <strong>Responsive layout</strong> that works on all screen
                  sizes
                </li>
                <li>
                  • <strong>Content type icons</strong> instead of placeholder
                  images
                </li>
                <li>
                  • <strong>Efficient information hierarchy</strong> with better
                  scannability
                </li>
                <li>
                  • <strong>Improved mobile experience</strong> with
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-blue-800">
              When actual thumbnails become available, you can easily implement
              the adaptive design pattern that automatically chooses between
              image-based and text-focused layouts based on content
              availability.
            </p>
          </div>
        </section>
