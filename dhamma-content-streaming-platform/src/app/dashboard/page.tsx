          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-blue-100 dark:bg-blue-900/20 rounded-lg">
                <FeatureIcons.Rocket className="w-5 h-5 text-blue-600 dark:text-blue-400" />
              </div>
              <div>
                <h3 className="font-medium text-gray-900 dark:text-white">Learning Paths</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">3 active paths</p>
              </div>
            </div>
          </div>
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <div className="p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900 dark:text-white">
                      Started new learning path: &quot;The Noble Eightfold Path&quot;
                    </p>
